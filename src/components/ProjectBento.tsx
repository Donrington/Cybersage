...
const PROJECTS: Project[] = [
  // ── TOP TIER ──────────────────────────────────────────────────────────────
  {
    ...
    tagline: 'Dual-sided automotive marketplace on Go microservices. Real-time inventory, Redis-cached feeds, React seller dashboard.',
    insight: '30% DB latency reduction via Redis caching + Go connection pooling',
  ...
  },
  {
    ...
    tagline: 'Full stack for a paramedical clinic. Secure patient portals, treatment tracking, headless CMS for the ops team.',
    insight: 'REST API with JWT + refresh token rotation; HIPAA-compliant data handling',
  ...
  // ── MID TIER ──────────────────────────────────────────────────────────────
  {
    ...
    tagline: 'Platform for Chartered Accountants to handle compliance, manage documents, and keep audit records clean.',
    insight: 'Encrypted document pipelines; zero breaches since launch',
  ...
  },
  {
    ...
    insight: '+25% user engagement via CI/CD pipeline automation + performance-first build',
  ...
  },
  {
    ...
    tagline: 'Headless CMS for an oil & gas company with workflow automation, document generation, and role-based access.',
    insight: 'Custom document generation pipeline; cut manual workflow ops by 60%',
    stack: ['NEXT.JS', 'DJANGO', 'POSTGRES'],
    status: 'DEPLOYED',
    engine: 'ENGINE_v5.0',
    col: 'lg:col-span-4',
  ...
  {  
    ...
    tagline: 'Corporate site for an oil & gas company. Custom GSAP animations, SEO-first build, 98/100 on Lighthouse.',
    insight: 'Sub-1s LCP via ISR + asset optimization; SEO score 98',
  ...
  },
  {
    ...
    insight: 'Real-time production data via WebSocket feeds; compliance audit trail baked in',
  ...
  },
  {
    ...
    insight: 'Conversion-tuned architecture; 3× qualified lead growth',
  ...
  },
  {
    ...
    insight: 'GSAP-driven animations at 60fps; sub-800ms FCP',
  ...
  // ── DIGITAL SERVICES TIER ─────────────────────────────────────────────────
  {
    ...
    insight: 'Conversion-tuned landing stack; qualified service bookings up since launch',
  ...
  },
  {
    ...
    insight: 'Instant quote flow cut form drop-off by 40%',
    stack: ['REACT', 'NODE.JS', 'TAILWIND'],
    status: 'LIVE',
    engine: 'ENGINE_v1.4',
    col: 'lg:col-span-4',
  ...
  },
  {
    ...
    insight: 'Community-driven with real-time activity feeds and peer collaboration tools',
    stack: ['REACT', 'NODE.JS', 'POSTGRES'],
    status: 'OPEN_SOURCE',
    engine: 'ENGINE_v1.0',
    col: 'lg:col-span-4',
  ...
  // ── BASE TIER ─────────────────────────────────────────────────────────────
  {
    ...
    tagline: 'Travel management app with booking engine, itinerary builder, and integrations with global travel providers.',
    insight: 'Booking API with rate-limiting + idempotent payment transactions',
    stack: ['NEXT.JS', 'DJANGO', 'POSTGRES'],
    status: 'DEPLOYED',
    engine: 'ENGINE_v2.0',
    col: 'lg:col-span-4',
  ...
  },
  {
    ...
    insight: 'Stripe webhooks with idempotency keys; inventory sync via pg_notify',
  ...
  },
  {
    ...
    tagline: 'Brand site for KRK Motors. GSAP animations, sub-1s load, clean automotive aesthetic.',
  ...
  },
  {
    ...
    tagline: 'SEO-optimised service platform for a vinyl flooring specialist. Service showcase, quote request funnels, and conversion-tuned landing pages.',
    insight: 'SEO-first architecture with conversion-optimised inquiry funnels and sub-1s LCP',
    stack: ['NEXT.JS', 'TAILWIND', 'SEO'],
    status: 'LIVE',
    engine: 'ENGINE_v1.2',
    col: 'lg:col-span-4',
    ...
    sysType: 'TYPE: SERVICE_PLATFORM // SECTOR: HOME_SERVICES',
    payload: 'PAYLOAD_v1.2',
    bgImage: '/tuantling.png',
    bgOverlay: 'linear-gradient(to bottom, rgba(26,26,26,0.25) 0%, rgba(26,26,26,0.55) 48%, rgba(26,26,26,0.93) 88%), linear-gradient(130deg, rgba(255,90,31,0.18) 0%, transparent 60%)',
    link: 'https://tuantlingvinylflooring.com',
    hud: {
      tl:     'SECTOR: HOME_SERVICES',
      bl:     'SEO: OPTIMISED',
      br:     'TYPE: VINYL_FLOORING',
      coord:  'COORD_ENCRYPTED',
      stress: 'SYSTEM_STRESS: 0.01%',
      deploy: 'T_DEPLOY: 9ms',
    },
