...
const MILESTONES: Milestone[] = [
  {
    ...
    desc: 'Built the full stack for a paramedical clinic. Secure patient portals, treatment tracking, a CMS the team could manage without a developer on call.',
    achievement: 'System architect // JWT + refresh token rotation, HIPAA-compliant data flow',
  ...
  },
  {
    ...
    role: 'Full Stack Developer',
    desc: 'Built the platform for Chartered Accountants to manage client intake, documents, and compliance audits in one place.',
    achievement: 'Audit platform live // Encrypted pipelines, zero breaches',
  ...
  },
  {
    ...
    desc: 'Built the web platform and cloud deployment setup for a robotics company. Go backend on AWS, CI/CD from scratch, kept API latency under 100ms.',
    achievement: 'CI/CD pipeline built from nothing // 25% user engagement lift after go-live',
  ...
  },
  {
    ...
    desc: 'Scaled a dual-sided automotive marketplace. React frontend, Go microservices on the backend, real-time inventory, payment integration, seller dashboards.',
    achievement: 'Marketplace handles concurrent traffic // 30% faster DB responses after Redis + connection pool tuning',
  ...
  },
  {
    ...
    role: 'Full Stack Developer',
    desc: 'Headless CMS for an oil and gas company. Custom document generation, role-based access, workflow automation for internal ops.',
    achievement: 'CMS delivered on schedule // Automated doc generation, manual ops down 60%',
  ...
  },
  {
    ...
    achievement: 'Brand site live // Sub-1s across all pages',
  ...
  },
  {
    ...
    achievement: 'Store live and processing orders // Stripe idempotency keys, pg_notify inventory sync',
  ...
  },
  {
    ...
    role: 'Web Developer',
    desc: 'Corporate site for an oil and gas company. Custom animations, SEO-first build, 98/100 on Lighthouse.',
    achievement: 'Site live // Sub-1s LCP, SEO score 98',
  ...
  },
  {
    ...
    achievement: 'Site live // 3× qualified lead growth',
  ...
  },
  {
    ...
    desc: 'Led development of a travel management app. Booking engine, itinerary builder, CMS, API integrations with global travel providers.',
    achievement: 'Travel platform delivered // Booking API with rate-limiting and idempotent payments',
  ...
  },
  {
    ...
    desc: 'Led the dev team during my internship at Zidio. Kept sprints unblocked, hit every deadline.',
    achievement: 'Team lead across 3 sprints // Nothing slipped',
  ...
  },
  {
    ...
    achievement: 'Integration layer shipped // DB query tuning, latency down across services',
  ...
  },
  {
    ...
    achievement: 'Full product ownership // Feature shipping, profiling, client handoff',
  ...
  },
  {
    ...
    achievement: 'QA automation built // Manual inspection time down 40%',
